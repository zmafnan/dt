...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="aristotle_global-user 16 BP2A.250605.031.A3 OS3.0.5.0.WMFMIXM release-keys" \
    BuildFingerprint=Xiaomi/aristotle_global/aristotle:16/BP2A.250605.031.A3/OS3.0.5.0.WMFMIXM:user/release-keys \
